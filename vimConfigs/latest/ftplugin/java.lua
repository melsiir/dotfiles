...
if vim.fn.filereadable(lombok_path) == 0 then
  vim.notify(
    "Lombok JAR not found at: " .. lombok_path .. ". JDTLS might work but Lombok features won't.",
    vim.log.levels.WARN
  )
end

local root_markers = { ".git", "mvnw", "gradlew", "pom.xml", "build.gradle", "build.gradle.kt" }
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          ...
          {
            name = "JavaSE-25",
            path = "/data/data/com.termux/files/usr/lib/jvm/java-25-openjdk/",
          },
        },
      },
    },
