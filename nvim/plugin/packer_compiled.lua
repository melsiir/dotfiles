...
_G.packer_plugins = {
  ...
  ["lualine-lsp-progress"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/lualine-lsp-progress",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'which-key.nvim', 'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
