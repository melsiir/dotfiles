...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "LuaSnip", "nvim-autopairs" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'friendly-snippets', 'nvim-colorizer.lua', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
