...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "nvim-autopairs", "cmp-cmdline" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'which-key.nvim', 'emmet-vim', 'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
