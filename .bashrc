...
if command -v eza &>/dev/null; then
  ...
  alias lll="eza --group-directories-first -lagF --git --time-style=long-iso --icons always"
  alias lt="eza -aT --color=always --icons --group-directories-first"
  # only show hidden
  alias l.="eza -a | grep -e '^\.'"
  # list dirs only
  alias dir="eza --only-dirs -a --icons auto --color auto"
  # sort by extension
  alias lx="eza --sort ext --color auto --icons --group-directories-first"
  # sort by size"
  alias lk="eza --grid --long --header --no-permissions --no-time --no-user --across"
  # sort by change time"
  alias lc="eza --sort changed --color auto --icons --group-directories-first"

  alias lu="eza --sort accessed --color auto --icons --group-directories-first"
  # "sort by access time"
  alias lr="eza -R --color auto --icons --group-directories-first"
  # "sort by date"
  alias lt="eza --sort date --color auto --icons --group-directories-first"
else
